...
@SpringBootTest
public class DashboardProductServiceTest {
    @Autowired
    ...
    public void findAllProductTest() {
        ...
        Map<String, Object> tempData = dashboardProductService.findAllProduct(test);
    ...
    public void findProductwithPageableTest() {
        List<ProductBean> temp = dashboardProductService.findProductwithPageable(10, 10);
    ...
    public void countProductTest() {
        Integer temp = dashboardProductService.countProduct();
