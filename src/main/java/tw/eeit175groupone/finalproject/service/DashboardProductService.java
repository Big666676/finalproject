...
public class DashboardProductService {
    ...
    /**
     * 用於根據前端使用者的搜尋條件，找出對應的所有商品資訊提供前端管理者
     * @param request--搜尋條件
     * @return Map--Key:data Value商品資料;Key:countOfData Value商品數
     */
     ...
     * @return List<CompleteProductInfo>排序後的商品
     */
